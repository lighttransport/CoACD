...
namespace coacd
{
    ...
    inline void addPoint(map<int, int> &vertex_map, vector<vec3d> &border, const vec3d &pt, int id, int &idx)
    {
    ...
    inline void addEdgePoint(map<pair<int, int>, int> &edge_map, vector<vec3d> &border, const vec3d &pt, int id1, int id2, int &idx)
    {
    ...
    inline bool FaceOverlap(const map<int, bool> &overlap_map, const vec3i &triangle)
    {
